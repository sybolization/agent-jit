...
export type RoutingPromptVariant =
  | "baseline"
  | "trigger"
  | "tool-embedded"
  | "tool-embedded-mini";
...
export function executeProgramDescription(variant: RoutingPromptVariant): string {
  switch (variant) {
    case "baseline":
...
export function describeProgramDescription(variant: RoutingPromptVariant): string {
  switch (variant) {
    case "baseline":
 ...
 */
export function renderRoutingDslReference(): string {

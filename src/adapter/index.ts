...
export {
  ...
  type RegisteredToolHarnessOptions,
} from "./toolAdapter.js";
...
export {
  ...
  installLegacyDslJit,
  type HarnessJitDescribeOptions,
  type HarnessJitExecuteOptions,
  type HarnessJitToolsOptions,
  type HarnessLegacyDslInstallOptions,

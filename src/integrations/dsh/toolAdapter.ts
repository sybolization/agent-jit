...
export function adaptRegisteredTool(
  ...
  return {
    ...
    description,
    parameters: jsonSchemaFromTypebox(tool.inputSchema) as unknown as Record<string, unknown>,
    output: {
 ...
 */
export function dshToolAsRegisteredTool(definition: ToolDefinition, caller: DslToolCaller): RegisteredTool {
  return {
    id: definition.name,

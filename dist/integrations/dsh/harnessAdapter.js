...
function hasCatalogSurface(tools) {
...
export function dshToolAsHarnessContract(definition) {
    return {
...
export function harnessToolAsDshTool(definition) {
    return {
        name: definition.name,
        description: definition.description,
 ...
 */
export function createDshHarnessCatalog(tools, scope) {
    return {
        getTool(name) {
            if (!hasCatalogSurface(tools))
                return undefined;
 ...
 */
export function createDshHarnessAdapter(tools) {
    return {

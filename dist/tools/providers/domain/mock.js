 ...
 */
export const mockDomainToolSpecs = [
    defineTool({
        ...
        outputSchema: Type.Array(Type.Object({ id: Type.String(), name: Type.String() }, { additionalProperties: false })),
    }),
    defineTool({
        id: "crm.get_customer",
        ...
        outputSchema: Type.Object({ id: Type.String(), name: Type.String() }, { additionalProperties: false }),
    }),
    defineTool({
        id: "users.list_users",
        label: "List users",
        ...
        outputSchema: Type.Array(Type.Object({ id: Type.String(), email: Type.String(), name: Type.String() }, { additionalProperties: false })),
    }),
    defineTool({
        id: "email.prepare",
        label: "Prepare an email",
        description: "构造一封邮件（收件人 + 姓名）。",
        inputSchema: Type.Object({ to: Type.String(), name: Type.String() }, { additionalProperties: false }),
        outputSchema: Type.Object({ to: Type.String(), name: Type.String() }, { additionalProperties: false }),
    }),
];
export function createMockDomainTools() {
    ...
    return [
        ...
        { ...mockDomainToolSpecs[1], execute: async (args) => customers.find((c) => c.id === args.customer_id) ?? customers[0] },
        { ...mockDomainToolSpecs[2], execute: async () => users },
        {
            ...mockDomainToolSpecs[3],
            execute: async (args) => ({ to: args.to, name: args.name }),
        },
    ];
}

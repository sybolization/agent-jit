...
export const githubTools = [
    defineTool({
        ...
        outputSchema: Type.Array(Type.Object({
    ...
    defineTool({
        ...
        outputSchema: Type.Array(Type.Object({ login: Type.String(), contributions: Type.Integer() }, { additionalProperties: false, title: "Contributor" })),
    }),
    defineTool({

...
export const ValueExprSchema = Type.Union([
    Type.Object({ kind: Type.Literal("literal"), value: ExecutionLiteralSchema }, { additionalProperties: false }),
    Type.Object({ kind: Type.Literal("ref"), name: Type.String({ minLength: 1, maxLength: 200 }) }, { additionalProperties: false }),
]);
